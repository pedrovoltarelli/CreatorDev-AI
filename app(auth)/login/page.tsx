        ...
        <div className="w-full max-w-md">
          <div className="bg-gray-900/80 backdrop-blur-md rounded-2xl border border-gray-800/50 p-8 space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-400">Sign in to continue your content journey</p>
            </div>
            ...
            <div className="text-center text-gray-500 text-sm">
              Don&apos;t have an account? <a href="/register" className="text-purple-400 hover:text-purple-300 transition-colors">Sign up</a>
            </div>
          </div>
        </div>
      </main>
